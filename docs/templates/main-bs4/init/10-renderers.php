...
Layout()->setRendererIfEmpty('head.css.cdn'  , new Renderer\CssCdn($cdn));
Layout()->setRendererIfEmpty('head.js.links' , new Renderer\JsLinks());
Layout()->setRendererIfEmpty('head.js.cdn'   , new Renderer\JsCdn($cdn));
...
Layout()->setRendererIfEmpty('body.js.cdn'  , new Renderer\JsCdn($cdn));
