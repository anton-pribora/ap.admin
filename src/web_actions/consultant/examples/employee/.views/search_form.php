...
?>
  <div class="col-12">
    <label class="visually-hidden" for="inlineFormInput-name">ФИО</label>
    ...
    <label class="visually-hidden" for="inlineFormInput-post">Должность</label>
    <input type="text" class="form-control" id="inlineFormInput-post" placeholder="Должность" value="<?php echo Html($this->param('post'))?>" name="post">
  </div>
  <div class="col-12">
