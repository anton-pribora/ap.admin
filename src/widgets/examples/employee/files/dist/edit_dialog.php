...
?>
<script type="text/html" id="examplesEmployeeFilesEditDialog">
        ...
        <form @submit.prevent="save">
          <fieldset :disabled="loading" @change="onChange">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3 row">
                <label class="col-sm-2 col-form-label">MIME</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="data.mime">
                </div>
              </div>
              <div class="mb-3 row">
