app.component('profile-information-edit-dialog', {
  template: '#profileInformationEditDialog',
  data: () => ({
  ...
  methods: {
    ...
    async save() {
      ...
      this.result = await this.$delay(this.$do(`${this.widget}::save`, {data: this.data}));
  ...
  mounted() {
    ...
    this.$externalMethods.set('profile-information-edit-dialog()', this.show);
  }
});
